            ...
            <Section anchor={props.sectionId} additionalClasses={[classes.HeroContainer]}>
                ...
                <div className={classes.Hero}>
                    <div className={classes.Intro}>
                        ...
                        {data.image?.src && (
                            <Animation className={`${classes.Image} ${classes.wavingHand}`} type="waving-hand" duration={2500} iterationCount={3} restartOnClick={true} >
                                <GatsbyImage
                    ...
                    <h2 className={classes.Subtitle}>
                        ...
                        <u dangerouslySetInnerHTML={{ __html: data.subtitle.highlight }} />
